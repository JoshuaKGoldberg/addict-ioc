...
class DependencyInjectionContainer {
  ...
  setDefaults(registrationDefaults) {
    if (registrationDefaults) {
      ...
      if (this._isValidBoolean(registrationDefaults.autoCreateMissingSubscribers)) {
        this._config.registrationDefaults.autoCreateMissingSubscribers = registrationDefaults.autoCreateMissingSubscribers;
      }
    }
  }
