...
class TypeRegistrationSettings {
  ...
  get namedPropertyInjection() {
    return this._namedPropertyInjection ? this._namedPropertyInjection : this.defaults.namedPropertyInjection;
  }

  set namedPropertyInjection(value) {
    return this._namedPropertyInjection = value;
  }
}
