...
class TypeRegistrationSettings {
  ...
  get matchKeyToClassName() {
    return this._matchKeyToClassName ? this._matchKeyToClassName : this.defaults.matchKeyToClassName;
  }

  set matchKeyToClassName(value) {
    return this._matchKeyToClassName = value;
  }
}
