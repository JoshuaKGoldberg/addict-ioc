...
System.register(['path'], function (_export, _context) {
  ...
  var path, _typeof, _createClass, TypeRegistrationSettings, TypeRegistration, DependencyInjectionContainer;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('TypeRegistrationSettings', TypeRegistrationSettings = function () {
      ...
      _export('TypeRegistrationSettings', TypeRegistrationSettings);

      _export('TypeRegistration', TypeRegistration = function () {
      ...
      _export('TypeRegistration', TypeRegistration);

      _export('DependencyInjectionContainer', DependencyInjectionContainer = function () {
      ...
      _export('DependencyInjectionContainer', DependencyInjectionContainer);
    }
  };
});