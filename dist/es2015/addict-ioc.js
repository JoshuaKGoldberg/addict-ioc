...
export let TypeRegistrationSettings = class TypeRegistrationSettings {
...
export let TypeRegistration = class TypeRegistration {
...
export let DependencyInjectionContainer = class DependencyInjectionContainer {
  ...
  setDefaults(registrationDefaults) {
    if (registrationDefaults) {
      ...
      const defaultSettings = ['isSingleton', 'wantsInjection', 'isLazy', 'bindFunctions', 'autoCreateMissingSubscribers'];
  ...
  _initializeRegistrationDeclarations() {
    ...
    const declarations = ['dependencies', 'configure', 'singleton', 'noInjection', 'injectInto', 'injectLazy', 'onNewInstance', 'bindFunctions'];
